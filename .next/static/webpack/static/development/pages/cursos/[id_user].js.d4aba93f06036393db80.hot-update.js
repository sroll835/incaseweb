...
UserCursos.getInitialProps = function _callee(_ref) {
  var query, id_usuario, userwithcursos;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          query = _ref.query;
          console.log(query);
          id_usuario = query.id_user.split('_')[1]; //var cursos; 
        ...
        case 5:
          ...
          console.log("Hola " + JSON.stringify(userwithcursos));
...
//# sourceMappingURL=[id_user].js.d4aba93f06036393db80.hot-update.js.map