...
UserCursos.getInitialProps = function _callee(_ref) {
  var query, id_usuario, userwithcursos, cursos, action;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          cursos = userwithcursos[0].cursos;
          action = {
            type: 'ADD_CURSOS',
            payload: cursos
          };

          _this2.props.dispatch(action); //console.log("Hola " + userwithcursos[0].cursos);
...
//# sourceMappingURL=[id_user].js.22b3657e3d6db409ec00.hot-update.js.map