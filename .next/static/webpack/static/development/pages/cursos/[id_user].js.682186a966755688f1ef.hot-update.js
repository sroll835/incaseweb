    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          Object(_API_helpersAPI__WEBPACK_IMPORTED_MODULE_9__["getUserwithCursosByUserId"])(id_usuario).then(function (response) {
            console.log(response);
            console.log(JSON.stringify(response[0].cursos));
            cursos = JSON.stringify(response[0].cursos);
          });
          console.log("Sali del get");
          console.log(cursos);
...
//# sourceMappingURL=[id_user].js.682186a966755688f1ef.hot-update.js.map