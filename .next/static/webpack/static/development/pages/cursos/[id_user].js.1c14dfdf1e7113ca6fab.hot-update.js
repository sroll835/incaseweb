...
function CardCurso(props) {
  ...
  var action = {
    type: 'ADD_CURSOS',
    payload: this.props.cursos_usuario
  };
  props.dispatch(action);
  var curso = props.curso; //console.log(curso.titulo)

  function handleSubmit() {
    next_router__WEBPACK_IMPORTED_MODULE_9___default.a.push("/cursos/Manuel%20Felipe_12/" + curso.id_curso);
  }
...
//# sourceMappingURL=[id_user].js.1c14dfdf1e7113ca6fab.hot-update.js.map