...
function getCursowithClassesByIdCurso(id_curso) {
  var url = "http://localhost:8080/cursos/" + id_curso;
  return fetch(url).then(function (response) {
    return response.json();
  })["catch"](function (error) {
    return console.error(error);
...
var UserProfile = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(UserProfile, [{
    ...
    value: function handleSaveUser() {
      ...
      Object(_api_helpersAPI__WEBPACK_IMPORTED_MODULE_11__["updateUsuario"])(userupdt[0]);
    ...
    value: function render() {
      ...
      }, "Modificar usuario"), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_10__["Button"], {
        variant: "contained",
        color: "primary",
...
//# sourceMappingURL=[id_user].js.e66ff413c97615666528.hot-update.js.map